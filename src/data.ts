...
import {
  ...
  Vendor, Material, Asset, ComplianceItem,
...
export const initialMaintenanceTasks: MaintenanceTask[] = [
  { id: "maint-101", propertyId: "prop-1", title: "Greywater Filtration Flushing", description: "Quarterly flushing of greywater harvesting filtration system", component: "Greywater Harvesting System", category: "Preventive", priority: "Medium", status: "Completed", assignedTo: "James Otieno", technician: "James Otieno", vendor: "Davis & Shirtliff", estimatedCost: 120000, actualCost: 120000, targetDate: "2026-05-20", completedDate: "2026-05-20", verifiedBy: "Admin", phone: "254712345678", notes: "Filter membranes cleaned and reinstalled", partsUsed: "Replacement filter pads x4", labourHours: 6, downtime: 2, attachments: [], workOrderNumber: "WO-101" },
  { id: "maint-102", propertyId: "prop-1", title: "Security Gate Remote Integration", description: "Install and configure smart security gate remote integration", component: "Security Systems", category: "Corrective", priority: "High", status: "Assigned", assignedTo: "Peter Kamau", technician: "Peter Kamau", vendor: "Security Group Africa (SGA)", estimatedCost: 250000, actualCost: 0, targetDate: "2026-06-05", phone: "254722998877", notes: "Awaiting remote modules delivery", partsUsed: "", labourHours: 0, downtime: 0, attachments: [], workOrderNumber: "WO-102" },
  { id: "maint-103", propertyId: "prop-1", title: "Fire Alarm Sensor Calibration", description: "Annual calibration of all fire alarm sensors across the building", component: "Fire Safety Equipment", category: "Preventive", priority: "High", status: "In-Progress", assignedTo: "Sarah Wanjiku", technician: "Sarah Wanjiku", vendor: "Apex Fire Safety Kenya", estimatedCost: 180000, actualCost: 0, targetDate: "2026-06-12", phone: "254733445566", notes: "Floors 1-3 completed, floors 4-6 pending", partsUsed: "Calibration tools", labourHours: 12, downtime: 0, attachments: [], workOrderNumber: "WO-103" },
  { id: "maint-201", propertyId: "prop-2", title: "Electrical DB Board Rewiring", description: "Emergency rewiring of main distribution board after fault detection", component: "Electrical Infrastructure", category: "Emergency", priority: "Critical", status: "Completed", assignedTo: "Mike Mwangi", technician: "Mike Mwangi", vendor: "PowerLink Engineers Nairobi", estimatedCost: 460000, actualCost: 445000, targetDate: "2026-05-24", completedDate: "2026-05-24", verifiedBy: "Admin", phone: "254711223344", notes: "DB board fully rewired, tested and certified", partsUsed: "MCB x8, RCCB x2, busbars", labourHours: 16, downtime: 4, attachments: [], workOrderNumber: "WO-201" },
  { id: "maint-202", propertyId: "prop-2", title: "Roofing Sheet Replacement", description: "Full metal roofing sheet replacement across 3 blocks", component: "Roofing", category: "Corrective", priority: "High", status: "Pending", assignedTo: "", technician: "", vendor: "Mabati Rolling Mills Service", estimatedCost: 5800000, actualCost: 0, targetDate: "2026-07-15", phone: "254799887766", notes: "Pending assignment of roofing crew", partsUsed: "", labourHours: 0, downtime: 0, attachments: [], workOrderNumber: "WO-202" },
  { id: "maint-203", propertyId: "prop-2", title: "HVAC Motor Bearing Grease", description: "Grease replacement on low-efficiency HVAC motor bearings", component: "HVAC Systems", category: "Preventive", priority: "Medium", status: "In-Progress", assignedTo: "Daniel Kiprop", technician: "Daniel Kiprop", vendor: "Fundi HVAC Technicals", estimatedCost: 75000, actualCost: 0, targetDate: "2026-06-02", phone: "254705040302", notes: "Motor 1 of 3 serviced", partsUsed: "Bearing grease tubes x3", labourHours: 4, downtime: 1, attachments: [], workOrderNumber: "WO-203" },
  { id: "maint-301", propertyId: "prop-3", title: "Elevator Hoist Motor Diagnostic", description: "Diagnostic inspection of elevator hoist motor for vibration issues", component: "Elevators", category: "Inspection", priority: "Medium", status: "Verified", assignedTo: "Joseph Maina", technician: "Joseph Maina", vendor: "Otis East Africa Ltd", estimatedCost: 320000, actualCost: 310000, targetDate: "2026-05-15", completedDate: "2026-05-15", verifiedBy: "Admin", phone: "254788111222", notes: "Motor inspected, bearings replaced, vibration resolved", partsUsed: "Bearings x4, seals x2", labourHours: 8, downtime: 6, attachments: [], workOrderNumber: "WO-301" },
  { id: "maint-302", propertyId: "prop-3", title: "Rooftop Rain Gutter Clearing", description: "Seasonal clearing of rooftop rain gutters and downspouts", component: "Roofing", category: "Preventive", priority: "Low", status: "Pending", assignedTo: "", technician: "", vendor: "Local Property Artisans Ltd", estimatedCost: 45000, actualCost: 0, targetDate: "2026-06-10", phone: "254701239845", notes: "Awaiting crew assignment", partsUsed: "", labourHours: 0, downtime: 0, attachments: [], workOrderNumber: "WO-302" }
];
...
export const initialSystemSettings: SystemSettings = {
  ...
  auditLogs: [
    ...
    { id: "log-4", timestamp: "2026-07-03T14:20:00Z", userId: "user-engineer", userName: "Jane Atieno", role: "Facility Manager", action: "Asset Inspection", details: "Completed HVAC motor bearing inspection at Thika Road Commercial Park", propertyId: "prop-2" }
  ]
};
